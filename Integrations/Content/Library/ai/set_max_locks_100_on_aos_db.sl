namespace: ai
flow:
  name: set_max_locks_100_on_aos_db
  workflow:
          ...
          io.cloudslang.base.powershell.powershell_script:
            ...
            - script: |
                ...
                if (Test-Path $configFile) {
                    (Get-Content $configFile) -replace '^(#?)max_locks_per_transaction\s*=.*', 'max_locks_per_transaction = 100' | Set-Content $configFile
                    Write-Host "Configuration updated to 100 in $configFile"
                } else {
